...
const isHaveServer = fs.existsSync(Cwd("server"));
const isBuildStatic = isHaveSrc && process.env.BUILD !== "server";
const isBuildServer = isHaveServer && process.env.BUILD !== "static";
const define = {
